...
int main()
{
    QString filename=":/new/prefix1/Imagenes/colombiasmall.png";
   ...
   // cout << "Valor en GREEN del pixel selccionado: "<<im.pixelColor(pixelX, pixelY).green()<<endl;
    ...
    /*int matrizpixels[256][3]={{ 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0}, { 255, 205, 0},
     ...
     for(int i=0,  j=0; i<256; i++, j++){
         ...
         cout<<"Matriz["<<i<<"]="<<"("<<matrizpixels[i][0]<<", "<<matrizpixels[i][1]<<", "<<matrizpixels[i][2]<<")"<<endl;
